...
| [**17**](https://openjdk.java.net/projects/jdk/17/) | **LTS** | **09/2021**	 | Sealed Classes     | **Supported LTS verison.** Consider upgrading to 21 in the next months.                                                                                                                                                                                                             |
...
| [**21**](https://openjdk.java.net/projects/jdk/21/)     | **LTS** | 09/2023	     | [Pattern Matching](https://wscp.dev/posts/tech/java-pattern-matching/), Virtual Threads                   | **Current LTS version.** (Not yet available from all distributions -> stick to 17)                                                                                                                                                           |
