...
| [18](https://openjdk.java.net/projects/jdk/18/)     | Feature | 03/2022	     | [UTF-8 by Default](https://openjdk.java.net/jeps/400)   | Stick to 17!<br>It is a short term release without  significant features. You might want to check if you run in any issues with "UTF-8 by Default".                                                                                                                                                            |
